...
public struct MTLLayeredBuffer<Layer: MTLBufferLayer> {
    ...
    public mutating func changeCapacity(device: MTLDevice, capacity: Int) {
        ...
        if #available(iOS 14, macOS 11, tvOS 14, *) {
            ...
            #else
                fatalError("This case should never execute!")
            #endif
            case .private:
                options = .storageModePrivate
            case .memoryless:
                if #available(iOS 10, macOS 11, tvOS 10, macCatalyst 14, *) {
                    options = .storageModeMemoryless
                } else {
                    fatalError("This case should never execute!")
                }
            @unknown default:
                fatalError("The MTLStorageMode with rawValue (\(buffer.storageMode) is not supported by MTLLayeredBuffer!")
            }
        }
...
public extension MTLComputeCommandEncoder {
    ...
    @available(iOS 13, tvOS 13, macCatalyst 14, *)
    @inlinable @inline(__always)
...
@available(iOS 13, macOS 11, tvOS 13, *)
...
public extension MTLRenderCommandEncoder {
    ...
    /**
     ...
     - Parameters:
        - bound: Whether the `MTLLayeredBuffer` is already bound at the index passed into this function. Set this to `true` whenever possible to decrease this function's execution time.
     */
    @available(macOS 11, tvOS 14.5, macCatalyst 14, *)
    @inlinable @inline(__always)
    ...
    @available(iOS 12, macOS 10.12, tvOS 14.5, *)
    @inlinable @inline(__always)
    ...
    @available(iOS 13, macOS 10.14, tvOS 13, *)
    @inlinable @inline(__always)
    func executeCommandsInBuffer<Layer: MTLBufferLayer>(_ buffer: MTLIndirectCommandBuffer,
...
@available(iOS 12, macOS 14, tvOS 12, *)
...
public extension MTLBlitCommandEncoder {
    ...
    @available(iOS 13, macOS 11, macCatalyst 14, *)
    @inlinable @inline(__always)
...
@available(iOS 13, macOS 15, macCatalyst 14, *)
